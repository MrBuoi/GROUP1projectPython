...
def backgrounnd3():
    ...
    current_dir = os.path.dirname(os.path.abspath(__file__))
    assets_dir = os.path.join(current_dir, 'assets')
    img1_path = os.path.join(assets_dir, '3.png')
...
def background4():
    ...
    current_dir = os.path.dirname(os.path.abspath(__file__))
    assets_dir = os.path.join(current_dir, 'assets')
    img1_path = os.path.join(assets_dir, '4.png')
    img1 = get_img_as_base64(img1_path)
    # CSS tùy chỉnh cho nền và sidebar
    page_bg_img = f"""
    <style>
...
def background7():
    ...
    current_dir = os.path.dirname(os.path.abspath(__file__))
    assets_dir = os.path.join(current_dir, 'assets')
    img5_path = os.path.join(assets_dir, '7.png')
    img5 = get_img_as_base64(img5_path)
    # CSS tùy chỉnh cho nền và sidebar
    page_bg_img = f"""
    <style>
...
def background8():
    ...
    current_dir = os.path.dirname(os.path.abspath(__file__))
    assets_dir = os.path.join(current_dir, 'assets')
    img5_path = os.path.join(assets_dir, 'Thiết kế chưa có tên (4).png')
    img5 = get_img_as_base64(img5_path)
    # CSS tùy chỉnh cho nền và sidebar
    page_bg_img = f"""
    <style>
...
def background3():
    ...
    current_dir = os.path.dirname(os.path.abspath(__file__))
    assets_dir = os.path.join(current_dir, 'assets')
    img5_path = os.path.join(assets_dir, '3.png')
    img5 = get_img_as_base64(img5_path)
    # CSS tùy chỉnh cho nền và sidebar
    page_bg_img = f"""
    <style>
...
def background62():
    ...
    current_dir = os.path.dirname(os.path.abspath(__file__))
    assets_dir = os.path.join(current_dir, 'assets')
    img5_path = os.path.join(assets_dir, '62.png')
    img5 = get_img_as_base64(img5_path)
    # CSS tùy chỉnh cho nền và sidebar
    page_bg_img = f"""
    <style>
