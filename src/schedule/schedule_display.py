...
from style import css_timetable
def display_schedule(username):
    st.markdown(
        "<h1 style='color: white; text-align: center; font-size: 80px;'>Quản lý Thời gian biểu</h1>",
        unsafe_allow_html=True
    )
    
    css_timetable() #setting css
    ...
    # Hiển thị lịch trình
    st.markdown(
        "<h1 style='color: white; text-align: center; font-size: 80px;'>Lịch trình</h1>",
        unsafe_allow_html=True
    )
